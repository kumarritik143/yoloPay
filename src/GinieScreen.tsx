    ...
    <View style={{ flex: 1, backgroundColor: '#111', justifyContent: 'flex-end' }}>
      ...
      <View style={styles.bottomNav}>
        ...
        <TouchableOpacity style={styles.navItem} onPress={() => navigation.navigate('PaymentScreen')}>
          {payComponent({})}
          <Text style={styles.navLabelInactive}>yolo pay</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.navItemActive} onPress={() => navigation.navigate('GinieScreen')}>
          {ginieComponent({})}
          <Text style={styles.navLabelActive}>ginie</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
